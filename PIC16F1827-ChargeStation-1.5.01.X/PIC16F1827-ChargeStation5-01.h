/* 
 * File:   PIC16F1827-ChargeStation5-01.h
 * Author: kerikun11
 *
 * Created on 2015/02/16, 11:30
 */
#ifndef PIC16F1827_CHARGESTATION5_01_H
#define	PIC16F1827_CHARGESTATION5_01_H
...
void LCD_init(void) {
    ...
    LCD_Command(0x78); // Contrast set           : コントラスト調整データ(下位4ビット)
    LCD_Command(0x54); // Contrast set           : 昇圧回路有効、コントラスト調整データ(上位2ビット)
...
#endif	/* PIC16F1827_CHARGESTATION5_01_H */
