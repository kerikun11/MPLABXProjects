...
void AES_OFBEncrypt_header_example1(BLOCK_CIPHER_HANDLE handle);
void AES_OFBDecrypt_header_example1(BLOCK_CIPHER_HANDLE handle);

void AES_OFB_Examples(BLOCK_CIPHER_HANDLE handle)
{
    AES_OFBEncrypt_header_example1(handle);
    AES_OFBDecrypt_header_example1(handle);
}
...
void AES_OFBEncrypt_header_example1(BLOCK_CIPHER_HANDLE handle)
{
    ...
    BLOCK_CIPHER_16BV1_OFB_Initialize (handle, &context, CRYPTO_16BV1_ALGORITHM_AES, CRYPTO_16BV1_ALGORITHM_AES, AES_BLOCK_SIZE, (uint8_t *)initial_data, (void *)&keyStream, sizeof (keyStream), &AESKey128, CRYPTO_KEY_SOFTWARE, CRYPTO_AES_128_KEY);
    ...
    //Encrypt the data
    BLOCK_CIPHER_16BV1_OFB_Encrypt (handle, cipher_text, &num_bytes_encrypted, (void *) plain_text, sizeof(plain_text), BLOCK_CIPHER_OPTION_STREAM_CONTINUE);
...
void AES_OFBDecrypt_header_example1(BLOCK_CIPHER_HANDLE handle)
{
    ...
    //Encrypt the data
    BLOCK_CIPHER_16BV1_OFB_Decrypt (handle, plain_text, &num_bytes_decrypted, (void *) cipher_text, sizeof(cipher_text), BLOCK_CIPHER_OPTION_STREAM_CONTINUE);
