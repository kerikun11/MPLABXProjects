...
void TDES_ECBEncrypt_header_example1(BLOCK_CIPHER_HANDLE handle);
void TDES_ECBDecrypt_header_example1(BLOCK_CIPHER_HANDLE handle);

void TDES_ECB_Examples(BLOCK_CIPHER_HANDLE handle)
{
    TDES_ECBEncrypt_header_example1(handle);
    TDES_ECBDecrypt_header_example1(handle);
}
...
void TDES_ECBEncrypt_header_example1(BLOCK_CIPHER_HANDLE handle)
{
    ...
    BLOCK_CIPHER_16BV1_ECB_Initialize (handle, &context, CRYPTO_16BV1_ALGORITHM_TDES, CRYPTO_16BV1_ALGORITHM_TDES, TDES_BLOCK_SIZE, &TDESKey[0], CRYPTO_KEY_SOFTWARE, CRYPTO_64DES_3_KEY);
...
void TDES_ECBDecrypt_header_example1(BLOCK_CIPHER_HANDLE handle)
{
    ...
    //Encrypt the data
    BLOCK_CIPHER_16BV1_ECB_Decrypt (handle, plain_text, &num_bytes_decrypted, (void *) cipher_text, sizeof(cipher_text), BLOCK_CIPHER_OPTION_STREAM_START | BLOCK_CIPHER_OPTION_STREAM_COMPLETE | BLOCK_CIPHER_OPTION_PAD_NONE);
