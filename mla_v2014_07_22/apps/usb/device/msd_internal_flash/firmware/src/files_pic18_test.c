...
#include <driver/fileio/internal_flash.h>
    ...
    #define PARTITION_ATTRIBUTES(sector_num)    __attribute__((space(psv), address(FILES_ADDRESS + (sector_num * FILEIO_CONFIG_MEDIA_SECTOR_SIZE))))
...
const uint8_t MBR_ATTRIBUTES MasterBootRecord[5][FILEIO_CONFIG_MEDIA_SECTOR_SIZE] =
{
    //------------------------------------------------------------------------------
