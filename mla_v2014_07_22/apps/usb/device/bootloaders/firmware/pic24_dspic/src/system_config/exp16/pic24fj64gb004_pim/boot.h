...
#define	BOOT_CONFIG_USER_MEMORY_ERASE_PAGE_START                (BOOT_CONFIG_USER_MEMORY_START_ADDRESS/BOOT_ERASE_BLOCK_SIZE)
    ...
    #define BOOT_CONFIG_USER_MEMORY_END_ADDRESS_NO_CONFIGS      0x00005400
    #define BOOT_CONFIG_USER_MEMORY_END_ADDRESS_CONFIGS         0x000057F8
    #define BOOT_MEMORY_CONFIG_START_ADDRESS                    0x000057F8
    #define BOOT_MEMORY_CONFIG_END_ADDRESS                      0x00005800
#else
    #error "This bootloader only covers the PIC24FJ64GB004 family devices.  Please see another folder for the bootloader appropriate for the selected device."
#endif
