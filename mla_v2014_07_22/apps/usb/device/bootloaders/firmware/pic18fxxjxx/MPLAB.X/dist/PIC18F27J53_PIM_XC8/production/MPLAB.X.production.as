...
__CFG_WPDIS$OFF equ 0x0
	file	"dist/PIC18F27J53_PIM_XC8/production\MPLAB.X.production.as"
	line	#
...
l3299:
;main.c: 465: {ANCON1bits.PCFG12 = 1;};
	movlb	15	; () banked
	bsf	((3913))&0ffh,4	;volatile
	line	469
;main.c: 469: if(PORTBbits.RB0 == 1)
...
;main.c: 470: {
;main.c: 474: {ANCON1bits.PCFG12 = 0;};
...
;boot_18fxxjxx.c: 356: PacketToPC.Address2 = (unsigned long)(uint32_t)0x01FFF8;
	movlw	low(01FFF8h)
...
;boot_18fxxjxx.c: 371: {
;boot_18fxxjxx.c: 372: MaxPageToErase = (((uint32_t)0x01FFF8)/1024);
	movlw	low(07Fh)
	movwf	((c:_MaxPageToErase)),c
	line	373
;boot_18fxxjxx.c: 373: ProgramMemStopAddress = ((uint32_t)0x01FFF8);
	movlw	low(01FFF8h)
...
;boot_18fxxjxx.c: 376: {
;boot_18fxxjxx.c: 377: MaxPageToErase = ((((uint32_t)0x01FFF8)/1024) - 1);
	movlw	low(07Eh)
	movwf	((c:_MaxPageToErase)),c
	line	378
;boot_18fxxjxx.c: 378: ProgramMemStopAddress = ((((((uint32_t)0x01FFF8)/1024) - 1) + 1) * 1024);
	movlw	low(01FC00h)
	movwf	((c:_ProgramMemStopAddress)),c
	movlw	high(01FC00h)
	movwf	((c:_ProgramMemStopAddress+1)),c
...
l3107:
;main.c: 776: LATCbits.LATC2 = 0;
	bcf	((c:3979)),c,2	;volatile
	line	777
	
l3109:
;main.c: 777: TRISCbits.TRISC2 = 0;
...
l2323:
;boot_18fxxjxx.c: 280: MaxPageToErase = ((((uint32_t)0x01FFF8)/1024) - 1);
	movlw	low(07Eh)
	movwf	((c:_MaxPageToErase)),c
	line	281
;boot_18fxxjxx.c: 281: ProgramMemStopAddress = ((((((uint32_t)0x01FFF8)/1024) - 1) + 1) * 1024);
	movlw	low(01FC00h)
	movwf	((c:_ProgramMemStopAddress)),c
	movlw	high(01FC00h)
	movwf	((c:_ProgramMemStopAddress+1)),c
...
;usb_device.c: 1604: TempBDT.ADR = (uint8_t*)&EP0OutEvenBuf[0];
	...
	line	1605
;usb_device.c: 1605: pBDTEntry = (volatile BDT*)0xD00;
		movlw	low(0D00h)
...
;usb_device.c: 1608: {
;usb_device.c: 1609: pBDTEntry = (volatile BDT*)(0xD00 + 4);
		movlw	low(0D04h)
	movwf	((c:LoadBDTandSetUOWN@pBDTEntry)),c
	movlw	high(0D04h)
	movwf	((c:LoadBDTandSetUOWN@pBDTEntry+1)),c
...
;main.c: 820: else
;main.c: 821: {
;main.c: 822: LATCbits.LATC2 = !LATCbits.LATC2;
