...
*
* Hardware:
*  PIC16F145x microcontroller revision A5 or later (A2 cannot be used; see
*  device family errata sheet [PFM self write])
*
* Required Linker Memory Model settings (for this bootloader project):
*       ROM ranges: default,-900-1FFF
*
* Required Linker Memory Model settings (for application projects meant to be programmed by this bootloader):
*       ROM ranges: default,-0-903
*       Codeoffset: 0x904
*
...
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
* 11/11/2013       1.00                            Initial version of this bootloader firmware.
* 2/20/2014                Manasi Khare (C13186)   Relocated Flash Signature Word address to avoid conflict with application interrupt code.
*                                                  Added startup_delay in main
******************************************************************************/
...
void InitializeSystem(void)
{
   //Configure oscillator settings to be compatible with USB operation
        ...
        #warning "Add oscillator initialization settings here."
