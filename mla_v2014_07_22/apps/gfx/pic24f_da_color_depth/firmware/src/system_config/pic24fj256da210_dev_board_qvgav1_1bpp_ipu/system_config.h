...
/*********************************************************************
  Overview: For PIC24FJ256DA210 builds only. This swaps the pixels
            ...
            Define this in gfx_config. to enable the swapping
            of the pixels.
...
#define GFX_DISPLAY_BUFFER_LENGTH               0x00002580ul

/*********************************************************************
* HARDWARE PROFILE FOR DISPLAY CONTROLLER FEATURES
*********************************************************************/
#define GFX_COMPRESSED_BUFFER_SIZE              (372)
#define GFX_DECOMPRESSED_BUFFER_SIZE            (2524)
