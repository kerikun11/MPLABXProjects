...
/*****************************************************************************
 * SECTION:  DroidSans_Bold_14 - Phrases
 *****************************************************************************/

const GFX_XCHAR AN1136Str[] = {   0x0028, 0x002C, 0x0021, 0x0021, 0x0023, 0x0025, 0x0000    };    // for Application Note 1136 string

const GFX_XCHAR AN1182Str[] = {   0x0028, 0x002C, 0x0021, 0x0021, 0x0027, 0x0022, 0x0000    };    // for Application Note 1182 string

const GFX_XCHAR AN1227Str[] = {   0x0028, 0x002C, 0x0021, 0x0022, 0x0022, 0x0026, 0x0000    };    // for Application Note 1227 string

const GFX_XCHAR AN1246Str[] = {   0x0028, 0x002C, 0x0021, 0x0022, 0x0024, 0x0025, 0x0000    };    // for Application Note 1246 string

const GFX_XCHAR MainStr[] = {   0x002B, 0x0030, 0x0034, 0x0037, 0x0000    };    // for the back to "Main" button

const GFX_XCHAR UseInternalResourceStr[] = {   0x002F, 0x003A, 0x0032, 0x000A,
                                              0x002A, 0x0037, 0x003B, 0x0032, 0x0039, 0x0037, 0x0030, 0x0035, 0x0020, 0x000A,
                                              0x002E, 0x0032, 0x003A, 0x0038, 0x003C, 0x0039, 0x0031, 0x0032, 0x003A, 0x0000    };    // for the string to display internal resource options

const GFX_XCHAR UseExternalResourceStr[] = {   0x002F, 0x003A, 0x0032, 0x000A,
                                              0x0029, 0x003D, 0x003B, 0x0032, 0x0039, 0x0037, 0x0030, 0x0035, 0x0020, 0x000A,
                                              0x002E, 0x0032, 0x003A, 0x0038, 0x003C, 0x0039, 0x0031, 0x0032, 0x003A, 0x0000    };    // for the string to display external resource options

const GFX_XCHAR UseProgramExternalResourceStr[] = {   0x002D, 0x0039, 0x0038, 0x0033, 0x0039, 0x0030, 0x0036, 0x000A,
                                                     0x0029, 0x003D, 0x003B, 0x0032, 0x0039, 0x0037, 0x0030, 0x0035, 0x000A,
                                                     0x002E, 0x0032, 0x003A, 0x0038, 0x003C, 0x0039, 0x0031, 0x0032, 0x003A, 0x0000    };    // for the string to display programming external resource options

/*****************************************************************************
 * SECTION:  DroidSans_Bold_14 - Unicode to GRC Index Table
 *****************************************************************************/

#ifdef GFX_LIB_CFG_USE_UNICODE_INDEX_TABLE
const uint16_t droidsans_bold_14UnicodeIndexTable[30][2] =
{
//    Unicode   GRC Index
//    -------   ---------
    {  0x0020,   0x0020  },
...
/*********************************
 * Bitmap Structure
 * Label: background_abstract_light_weave_4bpp_480x272
 * Description:  480x272 pixels, 4-bits per pixel
 ***********************************/
#if defined (GFX_CONFIG_IMAGE_PACKED_ENABLE) && (__XC16_VERSION__ >= 1011)
extern uint8_gfx_image_prog __background_abstract_light_weave_4bpp_480x272[] __attribute__((section("grc_images")));
#else
extern uint8_gfx_image_prog __background_abstract_light_weave_4bpp_480x272[] __attribute__((section("grc_images"), aligned(2)));
#endif

const GFX_RESOURCE_HDR background_abstract_light_weave_4bpp_480x272 =
{
    .type = (GFX_RESOURCE_MEMORY_FLASH | GFX_RESOURCE_TYPE_MCHP_MBITMAP | GFX_RESOURCE_COMP_NONE),
    .ID = 0,
    .resource.image.location.progByteAddress = (uint8_gfx_image_prog *) __background_abstract_light_weave_4bpp_480x272,
    .resource.image.width = 480,
    .resource.image.height = 272,
    .resource.image.parameter1.compressedSize = 0,
    .resource.image.parameter2.rawSize = 65316,
 ...
 * Description:  Height: 17 pixels, 2 bits per pixel, Range: ' ' to 'x'
 * Comment Block:
 *  
 *                                  Apache License 
...
extern GFX_FONT_SPACE char __DroidSans_Bold_14[] __attribute__((section("grc_text"), aligned(2)));
#else
extern GFX_FONT_SPACE char __DroidSans_Bold_14[] __attribute__((section("grc_text")));
#endif
#else
extern GFX_FONT_SPACE char __DroidSans_Bold_14[] __attribute__((aligned(2)));
#endif

const GFX_RESOURCE_HDR DroidSans_Bold_14 = 
{
    .type = (GFX_RESOURCE_MEMORY_FLASH | GFX_RESOURCE_TYPE_FONT | GFX_RESOURCE_COMP_NONE),
    .ID = 0x0000,
    .resource.font.location.progByteAddress = (GFX_FONT_SPACE char *) __DroidSans_Bold_14,
    ...
    .resource.font.header.lastChar = 0x003D,
...
#if defined(GFX_CONFIG_FONT_PROG_SPACE_ENABLE) && (__XC16_VERSION__ >= 1011)
#ifndef GFX_CONFIG_FONT_PACKED_ENABLE
extern GFX_FONT_SPACE char __Gentium27[] __attribute__((section("grc_text"), aligned(2)));
#else
extern GFX_FONT_SPACE char __Gentium27[] __attribute__((section("grc_text")));
#endif
#else
extern GFX_FONT_SPACE char __Gentium27[] __attribute__((aligned(2)));
#endif

const GFX_RESOURCE_HDR Gentium27 = 
{
    .type = (GFX_RESOURCE_MEMORY_FLASH | GFX_RESOURCE_TYPE_FONT | GFX_RESOURCE_COMP_NONE),
    .ID = 0x0000,
    .resource.font.location.progByteAddress = (GFX_FONT_SPACE char *) __Gentium27,
    .resource.font.header.fontID = 0,
    .resource.font.header.extendedGlyphEntry = 0,
    .resource.font.header.res1 = 0,
