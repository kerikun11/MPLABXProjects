...
IMPORTANT:
The GRC project an1182_graphics_resources.xml is included in this directory to show how the fonts
...
<install dir>/framework/gfx/resources/fonts directory. Each font will have its own sub-directory.

1. <install dir>/framework/gfx/resources/fonts/db/dbtt.ttf
2. <install dir>/framework/gfx/resources/fonts/jaipur/JAIPUR__.TTF
3. <install dir>/framework/gfx/resources/fonts/firefly/fireflysung.ttf
5. <install dir>/framework/gfx/resources/fonts/gentium/Gentium.ttf
