...
void TDES_SW_CFBEncrypt_header_example1(BLOCK_CIPHER_SW_HANDLE handle);
void TDES_SW_CFBDecrypt_header_example1(BLOCK_CIPHER_SW_HANDLE handle);

void TDESCFB_cfb8mmt3_encrypt_count1(BLOCK_CIPHER_SW_HANDLE handle);
void TDESCFB_cfb8mmt3_decrypt_count1(BLOCK_CIPHER_SW_HANDLE handle);

void TDESCFB_cfb1mmt3_encrypt_count1(BLOCK_CIPHER_SW_HANDLE handle);
void TDESCFB_cfb1mmt3_decrypt_count1(BLOCK_CIPHER_SW_HANDLE handle);

void TDES_SW_CFB_Examples(BLOCK_CIPHER_SW_HANDLE handle)
{
    TDES_SW_CFBEncrypt_header_example1(handle);
    TDES_SW_CFBDecrypt_header_example1(handle);
...
void TDES_SW_CFBEncrypt_header_example1(BLOCK_CIPHER_SW_HANDLE handle)
{
    ...
    BLOCK_CIPHER_SW_CFB_Initialize (handle, &context, TDES_SW_Encrypt, TDES_SW_Decrypt, TDES_SW_BLOCK_SIZE, (uint8_t *)initialization_vector, &round_keys, CRYPTO_SW_KEY_SOFTWARE_EXPANDED);

    //Encrypt the data
    BLOCK_CIPHER_SW_CFB_Encrypt (handle, cipher_text, &numCipherBytes, (void *) plain_text, sizeof(plain_text), BLOCK_CIPHER_SW_OPTION_STREAM_START);
...
void TDES_SW_CFBDecrypt_header_example1(BLOCK_CIPHER_SW_HANDLE handle)
{
    ...
    //Decrypt the data
    BLOCK_CIPHER_SW_CFB_Decrypt (handle, plain_text, &numPlainBytes, cipher_text, sizeof(cipher_text), BLOCK_CIPHER_SW_OPTION_STREAM_START);
...
void TDESCFB_cfb8mmt3_encrypt_count1(BLOCK_CIPHER_SW_HANDLE handle)
{
    ...
    // Initialize the Block Cipher context
    BLOCK_CIPHER_SW_CFB8_Initialize (handle, &context, TDES_SW_Encrypt, TDES_SW_Decrypt, TDES_SW_BLOCK_SIZE, (uint8_t *)initialization_vector, &round_keys, CRYPTO_SW_KEY_SOFTWARE_EXPANDED);
...
void TDESCFB_cfb1mmt3_encrypt_count1(BLOCK_CIPHER_SW_HANDLE handle)
{
    ...
    // Initialize the Block Cipher context
    BLOCK_CIPHER_SW_CFB1_Initialize (handle, &context, TDES_SW_Encrypt, TDES_SW_Decrypt, TDES_SW_BLOCK_SIZE, (uint8_t *)initialization_vector, &round_keys, CRYPTO_SW_KEY_SOFTWARE_EXPANDED);

    //Encrypt the data
    BLOCK_CIPHER_SW_CFB1_Encrypt (handle, cipher_text, &numCipherBytes, (void *) plain_text, 2, BLOCK_CIPHER_SW_OPTION_STREAM_START);
...
void TDESCFB_cfb1mmt3_decrypt_count1(BLOCK_CIPHER_SW_HANDLE handle)
{
    ...
    //Decrypt the data
    BLOCK_CIPHER_SW_CFB1_Decrypt (handle, plain_text, &numPlainBytes, cipher_text, 2, BLOCK_CIPHER_SW_OPTION_STREAM_START);
