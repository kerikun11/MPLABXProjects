...
void AES_SW_CBCEncrypt_header_example1(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_CBCDecrypt_header_example1(BLOCK_CIPHER_SW_HANDLE handle);

void AES_SW_CBCEncrypt_192bit(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_CBCDecrypt_192bit(BLOCK_CIPHER_SW_HANDLE handle);

void AES_SW_CBCEncrypt_256bit(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_CBCDecrypt_256bit(BLOCK_CIPHER_SW_HANDLE handle);

void AES_SW_CBC_Examples(BLOCK_CIPHER_SW_HANDLE handle)
{
    AES_SW_CBCEncrypt_header_example1(handle);
    AES_SW_CBCDecrypt_header_example1(handle);

    AES_SW_CBCEncrypt_192bit(handle);
    AES_SW_CBCDecrypt_192bit(handle);

    AES_SW_CBCEncrypt_256bit(handle);
    AES_SW_CBCDecrypt_256bit(handle);
}
...
void AES_SW_CBCEncrypt_header_example1(BLOCK_CIPHER_SW_HANDLE handle)
{
    ...
    BLOCK_CIPHER_SW_CBC_Initialize (handle, &context, AES_SW_Encrypt, AES_SW_Decrypt, AES_SW_BLOCK_SIZE, initialization_vector, &round_keys, CRYPTO_SW_KEY_SOFTWARE_EXPANDED);
