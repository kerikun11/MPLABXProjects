...
void AES_SW_GCM_Example1(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example2(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example3(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example4(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example5(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example6(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example7(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example8(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example9(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example10(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example11(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example12(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example13(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example14(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example15(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example16(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example17(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example18(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_GCM_Example19(BLOCK_CIPHER_SW_HANDLE handle);
...
const uint8_t ptNull[0];
const uint8_t ptZeros[16] = {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
const uint8_t ptFourBlocks[64] = {0xd9,0x31,0x32,0x25,0xf8,0x84,0x06,0xe5,0xa5,0x59,0x09,0xc5,0xaf,0xf5,0x26,0x9a,0x86,0xa7,0xa9,0x53,0x15,0x34,0xf7,0xda,0x2e,0x4c,0x30,0x3d,0x8a,0x31,0x8a,0x72,0x1c,0x3c,0x0c,0x95,0x95,0x68,0x09,0x53,0x2f,0xcf,0x0e,0x24,0x49,0xa6,0xb5,0x25,0xb1,0x6a,0xed,0xf5,0xaa,0x0d,0xe6,0x57,0xba,0x63,0x7b,0x39,0x1a,0xaf,0xd2,0x55};
const uint8_t ptShort[60] = {0xd9,0x31,0x32,0x25,0xf8,0x84,0x06,0xe5,0xa5,0x59,0x09,0xc5,0xaf,0xf5,0x26,0x9a,0x86,0xa7,0xa9,0x53,0x15,0x34,0xf7,0xda,0x2e,0x4c,0x30,0x3d,0x8a,0x31,0x8a,0x72,0x1c,0x3c,0x0c,0x95,0x95,0x68,0x09,0x53,0x2f,0xcf,0x0e,0x24,0x49,0xa6,0xb5,0x25,0xb1,0x6a,0xed,0xf5,0xaa,0x0d,0xe6,0x57,0xba,0x63,0x7b,0x39,};

const uint8_t authData[20] = {0xfe,0xed,0xfa,0xce,0xde,0xad,0xbe,0xef,0xfe,0xed,0xfa,0xce,0xde,0xad,0xbe,0xef,0xab,0xad,0xda,0xd2,};

const uint8_t ivZeros[12] = {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
const uint8_t ivValue[12] = {0xca,0xfe,0xba,0xbe,0xfa,0xce,0xdb,0xad,0xde,0xca,0xf8,0x88};
const uint8_t ivLong[60] = {0x93,0x13,0x22,0x5d,0xf8,0x84,0x06,0xe5,0x55,0x90,0x9c,0x5a,0xff,0x52,0x69,0xaa,0x6a,0x7a,0x95,0x38,0x53,0x4f,0x7d,0xa1,0xe4,0xc3,0x03,0xd2,0xa3,0x18,0xa7,0x28,0xc3,0xc0,0xc9,0x51,0x56,0x80,0x95,0x39,0xfc,0xf0,0xe2,0x42,0x9a,0x6b,0x52,0x54,0x16,0xae,0xdb,0xf5,0xa0,0xde,0x6a,0x57,0xa6,0x37,0xb3,0x9b,};
...
#define KEY_STREAM_SIZE     (AES_SW_BLOCK_SIZE * 4)
...
void AES_SW_GCM_Examples(BLOCK_CIPHER_SW_HANDLE handle)
{
    ...
    AES_SW_GCM_Example1(handle);
    AES_SW_GCM_Example2(handle);
    AES_SW_GCM_Example3(handle);
    AES_SW_GCM_Example4(handle);
    AES_SW_GCM_Example5(handle);
    AES_SW_GCM_Example6(handle);
    AES_SW_GCM_Example7(handle);
    AES_SW_GCM_Example8(handle);
    AES_SW_GCM_Example9(handle);
    AES_SW_GCM_Example10(handle);
    AES_SW_GCM_Example11(handle);
    AES_SW_GCM_Example12(handle);
    AES_SW_GCM_Example13(handle);
    AES_SW_GCM_Example14(handle);
    AES_SW_GCM_Example15(handle);
    AES_SW_GCM_Example16(handle);
    AES_SW_GCM_Example17(handle);
    AES_SW_GCM_Example18(handle);

    // Example 13 tests the GCM module with several usage modes.
    AES_SW_GCM_Example19(handle);
...
void AES_SW_GCM_Example1(BLOCK_CIPHER_SW_HANDLE handle)
{
    ...
    BLOCK_CIPHER_SW_GCM_Initialize (handle, &context, AES_SW_Encrypt, AES_SW_Decrypt, AES_SW_BLOCK_SIZE, (uint8_t *)ivZeros, 12, (void *)&keyStream, sizeof(keyStream), &round_keys, CRYPTO_SW_KEY_SOFTWARE_EXPANDED);

    //Generate 4 blocks of key stream
    BLOCK_CIPHER_SW_GCM_KeyStreamGenerate(handle, 4, 0);

    //Encrypt the data
    if (BLOCK_CIPHER_SW_GCM_Encrypt (handle, cipherText, &numCipherBytes, NULL, 0, tag, 16, BLOCK_CIPHER_SW_OPTION_STREAM_COMPLETE) != BLOCK_CIPHER_SW_ERROR_NONE)
    {
        // An error occured
        while(1);
    }
    ...
    // Decrypt the data
    if (BLOCK_CIPHER_SW_GCM_Decrypt (handle, plainText, &numPlainBytes, cipherText, 0, tag, 16, BLOCK_CIPHER_SW_OPTION_STREAM_COMPLETE) != BLOCK_CIPHER_SW_ERROR_NONE)
    {
        // An error occured
        while(1);
    }
...
void AES_SW_GCM_Example2(BLOCK_CIPHER_SW_HANDLE handle)
{
    ...
    //Encrypt the data
    if (BLOCK_CIPHER_SW_GCM_Encrypt (handle, cipherText, &numCipherBytes, (uint8_t *)ptZeros, 16, tag, 16, BLOCK_CIPHER_SW_OPTION_STREAM_COMPLETE) != BLOCK_CIPHER_SW_ERROR_NONE)
    {
        // An error occured
        while(1);
    }
    ...
    // Decrypt the data
    if (BLOCK_CIPHER_SW_GCM_Decrypt (handle, plainText, &numPlainBytes, cipherText, 16, tag, 16, BLOCK_CIPHER_SW_OPTION_STREAM_COMPLETE) != BLOCK_CIPHER_SW_ERROR_NONE)
    {
        // An error occured
        while(1);
    }
...
void AES_SW_GCM_Example3(BLOCK_CIPHER_SW_HANDLE handle)
{
    ...
    // Initialize the Block Cipher context
    BLOCK_CIPHER_SW_GCM_Initialize (handle, &context, AES_SW_Encrypt, AES_SW_Decrypt, AES_SW_BLOCK_SIZE, (uint8_t *)ivValue, 12, (void *)&keyStream, sizeof(keyStream), &round_keys, CRYPTO_SW_KEY_SOFTWARE_EXPANDED);

    //Generate 4 blocks of key stream
    BLOCK_CIPHER_SW_GCM_KeyStreamGenerate(handle, 4, 0);

    //Encrypt the data
    if (BLOCK_CIPHER_SW_GCM_Encrypt (handle, cipherText, &numCipherBytes, (uint8_t *)ptFourBlocks, 64, tag, 16, BLOCK_CIPHER_SW_OPTION_STREAM_COMPLETE) != BLOCK_CIPHER_SW_ERROR_NONE)
    {
        // An error occured
        while(1);
    }
    ...
    // Decrypt the data
    if (BLOCK_CIPHER_SW_GCM_Decrypt (handle, plainText, &numPlainBytes, cipherText, 64, tag, 16, BLOCK_CIPHER_SW_OPTION_STREAM_COMPLETE) != BLOCK_CIPHER_SW_ERROR_NONE)
    {
        // An error occured
        while(1);
    }
...
void AES_SW_GCM_Example4(BLOCK_CIPHER_SW_HANDLE handle)
{
    ...
    if (BLOCK_CIPHER_SW_GCM_Encrypt (handle, NULL, &numCipherBytes, (uint8_t *)authData, 20, NULL, 0, BLOCK_CIPHER_SW_OPTION_AUTHENTICATE_ONLY) != BLOCK_CIPHER_SW_ERROR_NONE)
    {
        // An error occured
        while(1);
    }
    ...
    //Encrypt the data
    if (BLOCK_CIPHER_SW_GCM_Encrypt (handle, cipherText, &numCipherBytes, (uint8_t *)ptShort, 60, tag, 16, BLOCK_CIPHER_SW_OPTION_STREAM_COMPLETE) != BLOCK_CIPHER_SW_ERROR_NONE)
    {
        // An error occured
        while(1);
    }
    ...
    if (BLOCK_CIPHER_SW_GCM_Decrypt (handle, NULL, &numPlainBytes, (uint8_t *)authData, 20, NULL, 0, BLOCK_CIPHER_SW_OPTION_AUTHENTICATE_ONLY) != BLOCK_CIPHER_SW_ERROR_NONE)
    {
        // An error occured
        while(1);
    }
    ...
    // Decrypt the data
    if (BLOCK_CIPHER_SW_GCM_Decrypt (handle, plainText, &numPlainBytes, cipherText, 60, tag, 16, BLOCK_CIPHER_SW_OPTION_STREAM_COMPLETE) != BLOCK_CIPHER_SW_ERROR_NONE)
    {
        // An error occured
        while(1);
    }
...
void AES_SW_GCM_Example5(BLOCK_CIPHER_SW_HANDLE handle)
{
    ...
    // Initialize the Block Cipher context
    BLOCK_CIPHER_SW_GCM_Initialize (handle, &context, AES_SW_Encrypt, AES_SW_Decrypt, AES_SW_BLOCK_SIZE, (uint8_t *)ivValue, 8, (void *)&keyStream, sizeof(keyStream), &round_keys, CRYPTO_SW_KEY_SOFTWARE_EXPANDED);
...
void AES_SW_GCM_Example6(BLOCK_CIPHER_SW_HANDLE handle)
{
    ...
    // Initialize the Block Cipher context
    BLOCK_CIPHER_SW_GCM_Initialize (handle, &context, AES_SW_Encrypt, AES_SW_Decrypt, AES_SW_BLOCK_SIZE, (uint8_t *)ivLong, 60, (void *)&keyStream, sizeof(keyStream), &round_keys, CRYPTO_SW_KEY_SOFTWARE_EXPANDED);
...
void AES_SW_GCM_Example19(BLOCK_CIPHER_SW_HANDLE handle)
{
    ...
    {
        // Authenticate the non-encrypted data
        if (BLOCK_CIPHER_SW_GCM_Encrypt (handle, NULL, &numCipherBytes, (uint8_t *)authData + i, 1, NULL, 0, BLOCK_CIPHER_SW_OPTION_AUTHENTICATE_ONLY) != BLOCK_CIPHER_SW_ERROR_NONE)
        {
            // An error occured
            while(1);
        }
    ...
    {
        //Encrypt the data
        if (BLOCK_CIPHER_SW_GCM_Encrypt (handle, cipherText + i, &numCipherBytes, (uint8_t *)ptShort + i, 1, tag, 16, BLOCK_CIPHER_SW_OPTION_STREAM_CONTINUE) != BLOCK_CIPHER_SW_ERROR_NONE)
        {
            // An error occured
            while(1);
        }
    ...
    //Encrypt the data
    if (BLOCK_CIPHER_SW_GCM_Encrypt (handle, cipherText + i, &numCipherBytes, (uint8_t *)ptShort + i, 1, tag, 16, BLOCK_CIPHER_SW_OPTION_STREAM_COMPLETE) != BLOCK_CIPHER_SW_ERROR_NONE)
    {
        // An error occured
        while(1);
    }
    ...
    // Initialize the Block Cipher context
    BLOCK_CIPHER_SW_GCM_Initialize (handle, &context, AES_SW_Encrypt, AES_SW_Decrypt, AES_SW_BLOCK_SIZE, (uint8_t *)ivValue, 12, (void *)&keyStream, 16, &round_keys, CRYPTO_SW_KEY_SOFTWARE_EXPANDED);
    ...
    //Generate 4 blocks of key stream
    BLOCK_CIPHER_SW_GCM_KeyStreamGenerate(handle, 1, 0);
    ...
    {
        //Encrypt the data
        if (BLOCK_CIPHER_SW_GCM_Encrypt (handle, cipherText + (i * 3), &numCipherBytes, (uint8_t *)ptShort + (i * 3), 3, tag, 16, BLOCK_CIPHER_SW_OPTION_STREAM_CONTINUE) != BLOCK_CIPHER_SW_ERROR_NONE)
        {
            // An error occured
            while(1);
        }
    ...
    //Encrypt the data
    if (BLOCK_CIPHER_SW_GCM_Encrypt (handle, cipherText + (i * 3), &numCipherBytes, (uint8_t *)ptShort + (i * 3), 3, tag, 16, BLOCK_CIPHER_SW_OPTION_STREAM_COMPLETE) != BLOCK_CIPHER_SW_ERROR_NONE)
    {
        // An error occured
        while(1);
    }
