...
void AES_SW_CTREncrypt_header_example1(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_CTRDecrypt_header_example1(BLOCK_CIPHER_SW_HANDLE handle);

void AES_SW_CTR_Examples(BLOCK_CIPHER_SW_HANDLE handle)
{
    AES_SW_CTREncrypt_header_example1(handle);
    AES_SW_CTRDecrypt_header_example1(handle);
}
...
void AES_SW_CTREncrypt_header_example1(BLOCK_CIPHER_SW_HANDLE handle)
{
    ...
    BLOCK_CIPHER_SW_CTR_Initialize (handle, &context, AES_SW_Encrypt, AES_SW_Decrypt, AES_SW_BLOCK_SIZE, (uint8_t *)initial_data, (void *)&keyStream, sizeof (keyStream), &round_keys, CRYPTO_SW_KEY_SOFTWARE_EXPANDED);
