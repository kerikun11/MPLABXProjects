...
void AES_SW_ECBEncrypt_header_example1(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_ECBDecrypt_header_example1(BLOCK_CIPHER_SW_HANDLE handle);

void AES_SW_ECBEncrypt_192bit(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_ECBDecrypt_192bit(BLOCK_CIPHER_SW_HANDLE handle);

void AES_SW_ECBEncrypt_256bit(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_ECBDecrypt_256bit(BLOCK_CIPHER_SW_HANDLE handle);

void AES_SW_ECB_Examples(BLOCK_CIPHER_SW_HANDLE handle)
{
    AES_SW_ECBEncrypt_header_example1(handle);
    AES_SW_ECBDecrypt_header_example1(handle);

    AES_SW_ECBEncrypt_192bit(handle);
    AES_SW_ECBDecrypt_192bit(handle);

    AES_SW_ECBEncrypt_256bit(handle);
    AES_SW_ECBDecrypt_256bit(handle);
}
...
void AES_SW_ECBEncrypt_header_example1(BLOCK_CIPHER_SW_HANDLE handle)
{
    ...
    BLOCK_CIPHER_SW_ECB_Initialize (handle, &context, AES_SW_Encrypt, AES_SW_Decrypt, AES_SW_BLOCK_SIZE, &round_keys, CRYPTO_SW_KEY_SOFTWARE_EXPANDED);
