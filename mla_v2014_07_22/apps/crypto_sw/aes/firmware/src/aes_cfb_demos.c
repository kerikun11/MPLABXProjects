...
void AES_SW_CFBEncrypt_header_example1(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_CFBDecrypt_header_example1(BLOCK_CIPHER_SW_HANDLE handle);

void AES_SW_CFBEncrypt_cfb8mmt_encrypt_count1(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_CFBEncrypt_cfb8mmt_decrypt_count1(BLOCK_CIPHER_SW_HANDLE handle);

void AES_SW_CFBEncrypt_cfb128mmt_encrypt_count1(BLOCK_CIPHER_SW_HANDLE handle);
void AES_SW_CFBEncrypt_cfb128mmt_decrypt_count1(BLOCK_CIPHER_SW_HANDLE handle);

void AES_SW_CFB_Examples(BLOCK_CIPHER_SW_HANDLE handle)
{
    AES_SW_CFBEncrypt_header_example1(handle);
    AES_SW_CFBDecrypt_header_example1(handle);

    AES_SW_CFBEncrypt_cfb8mmt_encrypt_count1(handle);
    AES_SW_CFBEncrypt_cfb8mmt_decrypt_count1(handle);

    AES_SW_CFBEncrypt_cfb128mmt_encrypt_count1(handle);
    AES_SW_CFBEncrypt_cfb128mmt_decrypt_count1(handle);
}
...
void AES_SW_CFBEncrypt_cfb128mmt_encrypt_count1(BLOCK_CIPHER_SW_HANDLE handle)
{
    ...
    // Initialize the Block Cipher context
    BLOCK_CIPHER_SW_CFB_Initialize (handle, &context, AES_SW_Encrypt, AES_SW_Decrypt, AES_SW_BLOCK_SIZE, initialization_vector, &round_keys, CRYPTO_SW_KEY_SOFTWARE_EXPANDED);
