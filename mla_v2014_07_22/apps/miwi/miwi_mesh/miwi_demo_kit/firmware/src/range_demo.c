...
void RangeDemo(void)
{
    ...
    /*******************************************************************/	
    LCD_BacklightON();
    LCD_Display((char *)"   Microchip       Range Demo  ", 0, true);
    LCD_BacklightOFF();
        ...
        if((MiWi_TickGetDiff(tick2,tick1) > (ONE_SECOND * TX_PKT_INTERVAL)))
    	{
    		...
    		{	      	
            	...
            	{   
                    ...
                    #endif    
            		{
                	sprintf((char *)&LCDText, (char*)"Strength: High ");
                        LED0 = 1;
                        LED1 = 0;
                        LED2 = 0;
                    }
                    ...
                    #endif
            		{
                        sprintf((char *)&LCDText, (char*)"Strength: Medium");
                        LED0 = 1;
                        LED1 = 1;
                        LED2 = 0;
                    } 
                    ...
                    #endif
            		{
                	sprintf((char *)&LCDText, (char*)"Strength: Low");
                        LED0 = 0;
                        LED1 = 1;
                        LED2 = 0;
                    }
