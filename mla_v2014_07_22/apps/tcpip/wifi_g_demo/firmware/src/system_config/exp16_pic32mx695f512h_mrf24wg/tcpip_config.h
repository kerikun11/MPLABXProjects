 ...
 * check whether the files (eg generic_tcp_client.c) are located in folder (eg \apps\tcpip\wifi_g_demo\firmware\src).
...
//#define STACK_USE_BERKELEY_API            // Berkerly Sockets APIs are available
...
#define MY_DEFAULT_IP_ADDR_BYTE4        (3ul)
...
#define MY_DEFAULT_PRIMARY_DNS_BYTE4    (3ul)
...
// =======================================================================
//   PIC32MX695F512H MAC Layer Options
        ...
        } TCPSocketInitializer[] =
        {
          ...
          // the same time, you might need to configure these sockets to be smaller
            ...
            {TCP_PURPOSE_UART_2_TCP_BRIDGE, TCP_ETH_RAM, 256, 256},
              ...
              {TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 800, 800},
            #else
              {TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 2048, 1000},
              {TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 2048, 1000},
            #endif
          #endif
...
// -- HTTP2 Server options -----------------------------------------------
    ...
    #define HTTP_MIN_CALLBACK_FREE  (1024u)
