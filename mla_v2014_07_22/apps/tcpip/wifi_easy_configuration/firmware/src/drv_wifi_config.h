 ...
 *     - max 4 clients allowed + active scan (RF module FW version 0x3108 / 0x310A / 0x310C)
...
* So if you have enough memory on PIC18/24, then you can also use this option with adding drv_wifi_pbkdf2.c
* in your projects.
*/
