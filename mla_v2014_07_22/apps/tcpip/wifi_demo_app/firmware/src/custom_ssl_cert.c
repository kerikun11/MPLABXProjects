...
// Key Material
    ...
    // is the exponent.
                ...
                ROM uint8_t SSL_N[] __attribute__ ((aligned(4))) = {
                ...
                ROM uint8_t SSL_D[] __attribute__ ((aligned(4))) = {
        ...
        // endian byte order, not network byte order (big endian).
        #if SSL_RSA_KEY_SIZE == 512u
                ROM uint8_t SSL_P[] __attribute__ ((aligned(4))) = {
                ...
                ROM uint8_t SSL_Q[]  __attribute__ ((aligned(4))) = {
                ...
                ROM uint8_t SSL_dP[]  __attribute__ ((aligned(4))) = {
                ...
                ROM uint8_t SSL_dQ[]  __attribute__ ((aligned(4))) = {
                ...
                ROM uint8_t SSL_qInv[] __attribute__ ((aligned(4))) = {
...
#if SSL_RSA_KEY_SIZE == 512u
        ROM uint8_t SSL_CERT[] __attribute__ ((aligned(4))) = {
...
// a compiler constant.
ROM uint16_t SSL_CERT_LEN = sizeof(SSL_CERT);
