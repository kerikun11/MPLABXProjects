...
// Comment this macro out if verification is done by the application.
...
typedef enum {
    ...
    M25P80_CMD_SER   = 0x20,         // erase sector (4 KByte of memory)
