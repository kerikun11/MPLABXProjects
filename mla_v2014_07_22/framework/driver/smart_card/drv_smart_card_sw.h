...
/*Need to move this into seperate file? Needs to discuss*/
void WaitMicroSec(int32_t microSec);
void WaitMilliSec(int32_t ms);


/*Needs to be eliminated , Temporary fix*/
void DRV_SMARTCARD_TC1Set(uint8_t data);
/*Needs to be eliminated , Temporary fix*/
void SetProtocolSelected(uint8_t data);
/*Needs to be eliminated , Temporary fix*/
uint8_t GetProtocolSelected(); // Warning removal
#endif
