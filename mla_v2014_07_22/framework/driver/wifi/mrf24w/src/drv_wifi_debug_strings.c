...
ROM char *connectionLostStrings[] = {
    ...
    static ROM char *P2PState[] = {
        ...
        ROM char *moduleName[] = {
            ...
            "drv_wifi_debug_strings.c",
            "iperf_app.c",
            "WFHostBridge.c", // not used
            "WF_iperfClient.c", // not used
            "WF_iperfServer.c", // not used
            "WF_iperfCommon.c" // not used
    };
    #else
        ROM char *moduleName[] = {
            "main.c",
...
#ifdef WIFI_NET_TEST
void wifi_net_test_print(char *str, uint32_t param)
{
    char buf[64];
