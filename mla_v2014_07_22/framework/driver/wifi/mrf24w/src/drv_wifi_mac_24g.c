...
static void ConfigWep(tWFWpsCred *cred, uint8_t *secType, union sec_key *key);
...
void RawSendUntamperedData(uint8_t *pReq, uint16_t len)
{
    ...
    // write out payload
    RawSetByte(RAW_TX_ID, (uint8_t *) pReq, len);
