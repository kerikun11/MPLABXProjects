...
#include "crypto_sw/src/poly1305/poly1305_sw_private.h"
#include <string.h>
#include <stdbool.h>

uint8_t POLY1305_SW_NEGATIVE_MODULUS[18] __attribute__((__aligned__)) = {0x05,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0C,0x00};
...
void POLY1305_SW_FastMod (POLY1305_SW_CONTEXT * context)
{
    ...
    POLY1305_SW_Add18to34 (context->a, POLY1305_SW_NEGATIVE_MODULUS, context->a);
