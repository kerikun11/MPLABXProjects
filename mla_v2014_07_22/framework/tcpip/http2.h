...
/*****************************************************************************
  ...
  Description:
    ...
    custom_http_app.c.  Its purpose is to parse the data received from
...
/*****************************************************************************
  ...
  Description:
    This function is implemented by the application developer in
    custom_http_app.c.  Its function is to determine if a file being
...
/*****************************************************************************
  ...
  Description:
    This function is implemented by the application developer in
    custom_http_app.c.  Its function is to determine if the user name and
...
/*****************************************************************************
  ...
  Description:
    ...
    custom_http_app.c.  These functions generate dynamic content to be
