 ...
 * Now we are using the new XC8 compiler which is a combination of C18 and Hi-Tech C
                            ...
                            uint32_t* h3, uint32_t* h4)
{
    ...
    TCPIP_UINT32_VAL *w = (TCPIP_UINT32_VAL*)lastBlock;
    ...
    for(i = 0; i < 80u; i++)
    {
        ...
        {
            #if defined(__XC8)
            // This section is unrolled for XC8 (from old HI_TECH_C) because it cannot parse
