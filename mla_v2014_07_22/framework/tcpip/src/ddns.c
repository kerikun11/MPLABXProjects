/*******************************************************************************
  ...
  Summary:
    DNS Update API Version 2.0.3 (www.dyndns.com)
...
#ifndef __DYNDNSCLIENT_C_
#define __DYNDNSCLIENT_C_
...
static ROM uint8_t _checkIpSrvrResponse[] = "Address:";
...
/****************************************************************************
  ...
  ***************************************************************************/
    ...
    static ROM uint16_t ddnsServicePorts[] =
    {
        80,                         // DYNDNS_ORG
        80,                         // NO_IP_COM
        80,                         // DNSOMATIC_COM
...
static uint32_t dwUpdateAt;     // Indicates when the next CheckIP should be done
...
void DDNSTask(void)
{
    ...
    switch(smDDNS)
    {
        case SM_IDLE:
            ...
            if((int32_t)(TickGet() - dwUpdateAt) < 0)
                break;
        ...
        case SM_BEGIN_CHECKIP:
            ...
            {
                MySocket = TCPOpen((uint32_t)(ROM_PTR_BASE)DDNSClient.CheckIPServer.szROM, TCP_OPEN_ROM_HOST,
        ...
        case SM_CHECKIP_SKT_OBTAINED:
            ...
            TCPPutROMString(MySocket, (ROM uint8_t*)"GET / HTTP/1.0\r\nHost: ");
        ...
        case SM_CHECKIP_FIND_DELIMITER:
            ...
            wPos = TCPFindROMArray(MySocket, (ROM uint8_t*)"Address: ", 9, 0, false);
        ...
        case SM_CHECKIP_FIND_ADDRESS:
            ...
            wPos = TCPFindROMArray(MySocket, (ROM uint8_t*)"</body>", 7, 0, false);
        ...
        case SM_IP_UPDATE_HOME:
            ...
            {
                MySocket = TCPOpen((uint32_t)(ROM_PTR_BASE)DDNSClient.UpdateServer.szROM, TCP_OPEN_ROM_HOST,
        ...
        case SM_IP_UPDATE_REQ_A:
            ...
            TCPPutROMString(MySocket, (ROM uint8_t*)"GET /nic/update?hostname=");
            smDDNS++;
        ...
        case SM_IP_UPDATE_REQ_C:
            ...
            TCPPutROMString(MySocket, (ROM uint8_t*)"&myip=");
            TCPPutString(MySocket, vBuffer);
            TCPPutROMString(MySocket, (ROM uint8_t*)"&wildcard=NOCHG&mx=NOCHG&backmx=NOCHG HTTP/1.0");
        ...
        case SM_IPUPDATE_FIND_RESPONSE:
            ...
            wPos = TCPFindROMArray(MySocket, (ROM uint8_t*)"\r\n\r\n", 4, 0, false);
...
void DDNSSetService(DDNS_SERVICES svc)
{
    ...
    DDNSClient.UpdateServer.szROM = (ROM uint8_t*)ddnsServiceHosts[svc];
