 ...
 * Author: kerikun11
 *
 * Created on 2015/06/02, 10:15
 */

#ifndef PIC18F27J53_CHARGESTATION6_04_H
#define	PIC18F27J53_CHARGESTATION6_04_H
...
void display_LCD(void) {
    ...
    switch (print_content) {
        ...
        case CHARGE_TIME://Port Name, xxxxxmAh
            ...
            uint8_t str[10];
            I2C_LCD_SetCursor(0, 1);
            utoa(str, charge_time[print_port] / 3600 / 24, 2);
            I2C_LCD_Puts(str);
            I2C_LCD_Puts("d ");
            utoa(str, (charge_time[print_port] / 3600) % 24, 2);
            I2C_LCD_Puts(str);
            I2C_LCD_Puts("h ");
            utoa(str, (charge_time[print_port] / 60) % 60, 2);
            I2C_LCD_Puts(str);
            I2C_LCD_Puts("m ");
            utoa(str, charge_time[print_port] % 60, 2);
            I2C_LCD_Puts(str);
            I2C_LCD_Puts("s");
            break;
        case RESET://Port Name, Reset?
            display_port();
            I2C_LCD_SetCursor(0, 1);
            I2C_LCD_Puts("Integrating Reset?");
            break;
        case RESETED://Port Name, Reseted
            display_port();
            I2C_LCD_SetCursor(0, 1);
            I2C_LCD_Puts("Integrating Reseted");
            break;
...
void normal_mode_loop(void) {
    ...
    if (print_content == TIME)RTCC_time_set(&ctm, &ct0, &ct1);
    if (display_flag) {
        display_flag = 0;
        display_LCD();
    }
