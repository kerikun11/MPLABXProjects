// ChargeStation 6.11
// PIC18F27J53
// 00 2015.03.12 初版、ChargeStation5からの引き継ぎ
// 01 2015.03.22 RTCC導入、LCDはI2C小型1602液晶
// 02 2015.04.30 CTMUタッチセンサ装備、charge_time_count充電時間カウント機能、（試作1号用pinアサイン）
// 03 2015.06.02 ケース組み込み1号用pinアサイン 切削基板
// 04 2015.06.04 USB_CDC 導入
// 05 2015.06.09 port構造体にまとめた
// 06 2015.06.15 SLEEP機能
// 06 2015.06.15 bootloader導入
// 07 2015.07.19 tx_bufferを構造体指定形式に統一→USBでもUARTでもOK
// 08 2015.08.11 settings導入
// 09 2015.09.06 settingsとりあえず完成版
// 10 2015.09.16 settings改良
// 11 2015.09.17 ファイル分割 My library
