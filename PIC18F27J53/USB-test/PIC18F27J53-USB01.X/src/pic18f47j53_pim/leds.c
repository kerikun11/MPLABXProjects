...
//
//#define LED_D1_TRIS TRISEbits.TRISE0
//#define LED_D2_TRIS TRISEbits.TRISE1

#define LED_D1_LAT LATBbits.LATB6
#define LED_D2_LAT LATBbits.LATB7

#define LED_D1_TRIS TRISBbits.TRISB6
#define LED_D2_TRIS TRISBbits.TRISB7
